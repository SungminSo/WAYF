...
extracted = pandas.read_csv("C:\\Users\\ssm74\\Projects\\WAYF\\Data\\extracted_data.csv")
for _, player in extracted.iterrows():
...
print(len(nation_id_dic.keys()))
print(nation_id_dic.keys())
print(total)
